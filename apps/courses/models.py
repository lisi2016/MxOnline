...
class Course(models.Model):
    ...
    image = models.ImageField(upload_to="resources/courses/%Y/%m", verbose_name=u"封面图")
...
class CourseResource(models.Model):
    ...
    download = models.FileField(upload_to="resources/course/resource/%Y/%m", verbose_name=u"资源文件")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
